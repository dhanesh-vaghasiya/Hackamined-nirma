...
import {
    Scan, AlertTriangle, Briefcase, TrendingUp, TrendingDown,
...
import { generateRoadmap, fetchDetailedRoadmap } from "../../services/career";
                                ...
                                >
                                    ...
                                    {step.url && (
                                        <a
                                            ...
                                            style={{ color: step.source === "youtube" ? "#DC2626" : "#97A87A" }}
                                        >
                                            {step.source === "youtube" ? (
                                                <><svg width="12" height="12" viewBox="0 0 24 24" fill="#DC2626"><path d="M23.5 6.2a3 3 0 00-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 00.5 6.2 31.9 31.9 0 000 12a31.9 31.9 0 00.5 5.8 3 3 0 002.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 002.1-2.1A31.9 31.9 0 0024 12a31.9 31.9 0 00-.5-5.8zM9.6 15.6V8.4l6.3 3.6-6.3 3.6z" /></svg> Watch on YouTube</>
                                            ) : (
...
export default function WorkerResultsUI({ analysis, profile, profileId }) {
    ...
    const [roadmapView, setRoadmapView] = useState("weekly");
    ...
    return (
        <motion.div variants={rightFull} initial="initial" animate="animate" exit="exit" className="flex flex-col gap-4 h-full overflow-y-auto custom-scroll pr-1">
            ...
            <motion.div variants={section} className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <motion.div variants={section} className="oasis-dash-card rounded-2xl p-5 mb-8">
